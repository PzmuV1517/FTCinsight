        ...
        for ty_data in team_years:
            ...
            if existing:
                ...
                new_ty = TeamYearORM(
                    ...
                    rookie_year=ty_data.get("rookie_year"),
                    competing_this_week=ty_data.get("competing_this_week", False),
                    ...
                    epa_pre_champs=ty_data.get("epa_pre_champs", 0.0),
                    epa_max=ty_data.get("epa_max", 0.0),
                    epa=ty_data.get("epa", 0.0),
                    epa_sd=ty_data.get("epa_sd", 0.0),
                    epa_skew=ty_data.get("epa_skew", 0.0),
                    epa_n=ty_data.get("epa_n", 0.0),
                    auto_epa=ty_data.get("auto_epa"),
                    teleop_epa=ty_data.get("teleop_epa"),
                    endgame_epa=ty_data.get("endgame_epa"),
                    unitless_epa=ty_data.get("unitless_epa", 0.0),
                    norm_epa=ty_data.get("norm_epa"),
                    total_epa_rank=ty_data.get("total_epa_rank"),
                    total_epa_percentile=ty_data.get("total_epa_percentile"),
                    total_team_count=ty_data.get("total_team_count"),
                    state_epa_rank=ty_data.get("state_epa_rank"),
                    state_epa_percentile=ty_data.get("state_epa_percentile"),
                    state_team_count=ty_data.get("state_team_count"),
                    country_epa_rank=ty_data.get("country_epa_rank"),
                    country_epa_percentile=ty_data.get("country_epa_percentile"),
                    country_team_count=ty_data.get("country_team_count"),
                    district_epa_rank=ty_data.get("district_epa_rank"),
                    district_epa_percentile=ty_data.get("district_epa_percentile"),
                    district_team_count=ty_data.get("district_team_count"),
                    ...
                    district_points=ty_data.get("district_points"),
                    district_rank=ty_data.get("district_rank"),
                )
                session.add(new_ty)
        ...
        return [
            {
                ...
                "state": ty.state,
                "epa": ty.epa,
                "total_epa_rank": ty.total_epa_rank,
                "wins": ty.wins,
                "losses": ty.losses,
                "count": ty.count,
            }
    ...
    with get_session() as session:
        ...
        for event_data in events:
            ...
            if existing:
                ...
                if not key or not event_data.get("year"):
                    continue
        ...
        for te_data in team_events:
            ...
            if existing:
                ...
                new_te = TeamEventORM(
                    ...
                    epa=te_data.get("epa", 0),
                    auto_epa=te_data.get("auto_epa"),
                    teleop_epa=te_data.get("teleop_epa"),
                    endgame_epa=te_data.get("endgame_epa"),
                    unitless_epa=te_data.get("unitless_epa", 0),
                    norm_epa=te_data.get("norm_epa", 0),
                    ...
                    rps=te_data.get("rps", 0),
                    rps_per_match=te_data.get("rps_per_match", 0.0),
                )
                session.add(new_te)
